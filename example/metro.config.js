...
config.resolver.extraNodeModules = {
  ...
  'expo-quest-notifications': path.resolve(workspaceRoot, 'expo-quest-notifications'),
};
...
config.resolver.resolveRequest = (context, moduleName, platform) => {
  const localPackages = {
    ...
    'expo-quest-location': path.resolve(workspaceRoot, 'expo-quest-location/src/index.ts'),
    'expo-quest-notifications': path.resolve(workspaceRoot, 'expo-quest-notifications/src/index.ts'),
  };
